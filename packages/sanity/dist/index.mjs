import { defineType, defineField, definePlugin, set, useDataset, useProjectId, useClient, useFormValue } from 'sanity';
import { MdBusiness, MdPerson, MdWeb, MdPageview, MdShoppingBag, MdStore, MdQuestionAnswer, MdEvent, MdCreate, MdArticle, MdEmail, MdPeople, MdSettingsSuggest, MdSearch, MdShare, MdInfo, MdPlaylistRemove, MdWarning, MdCheck, MdEdit, MdPreview } from 'react-icons/md';
import { useToast, Box, Grid, Stack, Flex, Button, useRootTheme, Card, Text, Avatar } from '@sanity/ui';
import { createContext, useCallback, useContext, useMemo, useState, useEffect } from 'react';
import { jsx, jsxs } from 'react/jsx-runtime';
import { IoSparklesSharp, IoArrowRedo } from 'react-icons/io5';
...
var schemaMarkupArticleFields = defineType({
...
var schemaMarkupProductFields = defineType({
...
var schemaMarkupEventFields = defineType({
...
var schemaMarkupFAQPageFields = defineType({
...
var schemaMarkupPersonFields = defineType({
...
var schemaMarkupAboutPageFields = defineType({
...
var schemaMarkupContactPageFields = defineType({
...
var schemaMarkupOrganization = defineType({
...
var schemaMarkupPerson = defineType({
...
var schemaMarkupFAQItem = defineType({
...
var schemaMarkupAddress = defineType({
...
var schemaMarkupAggregateRating = defineType({
...
var schemaMarkupGeo = defineType({
...
var meta_description_default = defineField({
...
var SeoDefaultsProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx(SeoDefaultsContext.Provider, { value: defaults, children });
};
...
function CardWithIcon({
  ...
  const Icon = icon;
  return /* @__PURE__ */ jsx(Card, { marginBottom: 3, tone, padding: 3, children: /* @__PURE__ */ jsxs(Flex, { gap: 2, align: "center", children: [
    Icon && /* @__PURE__ */ jsx(Icon, { size: 18 }),
    /* @__PURE__ */ jsx(Text, { size: 1, children: text })
  ] }) });
}
function InputWithGlobalDefault(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx(Box, { children: props.renderDefault(props) })
  ] });
}
...
function SocialCardWrapper(props) {
  return /* @__PURE__ */ jsx(Card, { border: false, radius: 2, tone: "neutral", children: props.children });
}
function FacebookCard(props) {
  ...
  return /* @__PURE__ */ jsxs(SocialCardWrapper, { children: [
    /* @__PURE__ */ jsxs(Flex, { gap: 2, padding: 3, className: FacebookCard_default.header, children: [
      /* @__PURE__ */ jsx(Avatar, { src: data.avatar, size: 3 }),
      /* @__PURE__ */ jsxs(Stack, { space: 2, children: [
        /* @__PURE__ */ jsx(Text, { weight: "semibold", size: 2, children: data.siteTitle }),
        /* @__PURE__ */ jsx(Text, { size: 1, muted: true, children: data.siteUrl })
      ] })
    ] }),
    /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx("img", { className: FacebookCard_default.image, src: data.image, alt: "Facebook preview" }) }),
    /* @__PURE__ */ jsx(Box, { padding: 3, children: /* @__PURE__ */ jsxs(Stack, { space: 3, children: [
      /* @__PURE__ */ jsx(Text, { size: 1, muted: true, children: data.siteUrl }),
      /* @__PURE__ */ jsx(Text, { weight: "semibold", size: 3, children: truncate(data.title, 60) }),
      /* @__PURE__ */ jsx(Box, { marginTop: 1, children: /* @__PURE__ */ jsx(Text, { size: 2, children: truncate(data.description, 110) }) })
    ] }) })
  ] });
}
...
function TwitterCard(props) {
  ...
  return /* @__PURE__ */ jsxs(SocialCardWrapper, { children: [
    /* @__PURE__ */ jsxs(Flex, { gap: 2, padding: 3, className: TwitterCard_default.userRow, children: [
      /* @__PURE__ */ jsx(Avatar, { src: data.avatar, size: 3 }),
      /* @__PURE__ */ jsxs(Stack, { space: 2, children: [
        /* @__PURE__ */ jsx(Text, { weight: "semibold", size: 2, children: data.siteTitle }),
        /* @__PURE__ */ jsx(Text, { size: 1, muted: true, children: data.twitterHandle })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsx(Box, { padding: 3, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 4, children: [
      /* @__PURE__ */ jsx(Text, { size: 1, muted: true, children: data.siteUrl }),
      /* @__PURE__ */ jsx(Text, { weight: "semibold", size: 3, children: truncate(data.title, 70) }),
      /* @__PURE__ */ jsx(Text, { size: 2, children: truncate(data.description, 120) })
    ] }) })
  ] });
}
...
function GoogleEntry(props) {
  ...
  return /* @__PURE__ */ jsx(SocialCardWrapper, { children: /* @__PURE__ */ jsx(Box, { padding: 3, children: /* @__PURE__ */ jsxs(Stack, { space: 3, children: [
    /* @__PURE__ */ jsxs(Flex, { align: "center", marginBottom: 2, gap: 2, children: [
      /* @__PURE__ */ jsx(Avatar, { size: 2, src: data.favicon, alt: "Favicon" }),
      /* @__PURE__ */ jsxs(Stack, { space: 2, children: [
        /* @__PURE__ */ jsx(Text, { size: 1, weight: "semibold", className: GoogleEntry_default.site, children: data.siteTitle }),
        /* @__PURE__ */ jsx(Text, { size: 1, muted: true, className: GoogleEntry_default.site, children: data.siteUrl })
      ] })
    ] }),
    /* @__PURE__ */ jsx(
      Text,
    ...
    /* @__PURE__ */ jsx(Text, { size: 2, muted: true, className: GoogleEntry_default.desc, children: truncate(data.description, 155) })
  ] }) }) });
}
...
function PreviewGroup({
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(Box, { marginBottom: 4, children: /* @__PURE__ */ jsx(Text, { weight: "semibold", size: 2, children: title }) }),
    children
  ] });
}
function ButtonWithIcon({
  ...
  const Icon = icon;
  return /* @__PURE__ */ jsx(Button, { ...buttonProps, children: /* @__PURE__ */ jsxs(Flex, { gap: 2, align: "center", justify: "center", children: [
    Icon && /* @__PURE__ */ jsx(Icon, { size: 17 }),
    /* @__PURE__ */ jsx(Text, { size: 1, weight: "semibold", children: label })
  ] }) });
}
var PREVIEW_GROUPS = [
  {
...
function PageSeoInput(props) {
  ...
  const [seoDefaults2, setSeoDefaults] = useState(null);
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(Box, { marginBottom: 4, width: "fill", children: /* @__PURE__ */ jsx(Flex, { gap: 2, width: "fill", children: MODES.map((m) => /* @__PURE__ */ jsx(
      ButtonWithIcon,
      {
        buttonProps: {
          padding: 2,
    ...
    currentMode === "preview" && /* @__PURE__ */ jsx(Flex, { gap: 6, marginTop: 6, direction: "column", children: PREVIEW_GROUPS.map((group) => /* @__PURE__ */ jsx(PreviewGroup, { title: group.title, children: /* @__PURE__ */ jsx(group.component, { ...seoData }) }, group.name)) })
  ] });
}
...
function PageSchemaMarkupInput(props) {
  return /* @__PURE__ */ jsx("div", { children: props.renderDefault(props) });
}
function ButtonSelector(props) {
  ...
  return /* @__PURE__ */ jsx(Box, { children: /* @__PURE__ */ jsx(Grid, { columns: 3, gap: 3, children: options.map((option, index) => {
...
function SeoLayoutWrapper(props) {
  return /* @__PURE__ */ jsx(SeoDefaultsProvider, { children: props.renderDefault(props) });
}

// src/schemas/fields/metadata/indexing.ts
var indexing_default = defineField({
  name: "searchVisibility",
...
function WindowControls() {
  ...
  return /* @__PURE__ */ jsx(
    Flex,
    {
      ...
      children: CONTROLS.map((c, i) => /* @__PURE__ */ jsx(
        "span",
        {
          title: c.title,
          style: {
  ...
  return /* @__PURE__ */ jsxs(
    Flex,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Flex, { direction: "column", justify: "center", align: "center", children: /* @__PURE__ */ jsx(
          Text,
          {
            size: 1,
            style: {
...
function FaviconPreview(props) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: favicon_preview_default.card, children: [
    /* @__PURE__ */ jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxs(Flex, { paddingX: 4, paddingY: 2, justify: "start", align: "center", children: [
          /* @__PURE__ */ jsx(WindowControls, {}),
          /* @__PURE__ */ jsx(
            BrowserTab,
            {
              url,
          ...
          /* @__PURE__ */ jsx(BrowserTab, {})
        ] })
      }
    ),
    /* @__PURE__ */ jsx(Box, { className: favicon_preview_default?.["image-preview"], children: props.renderDefault(props) })
  ] });
}

// src/schemas/fields/metadata/favicon.ts
var favicon_default = defineField({
  name: "favicon",
  type: "image",
  components: {
...
var schemaMarkupDefaults = defineType({
